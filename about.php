							...
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button">
										<?php
										if (isset($_SESSION['user'])) {
										echo"<a href='about.php?salir=1'>Cerrar Sesion</a>";
										}
										else {
					...
					echo "<a href='inicio.php'>
						...
						echo "<li><a href='inicio.php'>Hogar</a></li>";
								...
								echo "<li><a href='index.php'>Hogar</a></li>";
									...
									<li><a href="comentarios2.php">Comentarios</a></li>
						...
						<div class="accordions">
							...
							<div class="elements_accordions">
								...
								<div class="accordion_container">
									...
									<div class="accordion_panel">
										<p>AIE-Learning fue programado por los mejore estudiantes del Heavens Kingdom Christian School a nivel de informatica</p>
									</div>
								</div>
