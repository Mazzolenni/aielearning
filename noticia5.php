							...
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button">
										<?php
								if (isset($_SESSION['user'])) {
								echo"<a href='noticia5.php?salir=1'>Cerrar Sesion</a>";
								}
								else {
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm"><a href="cuestionario.php">Cuestionarioo</a></li>
			</ul>
		</nav>
	</div>
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">El pack completo del Lenguaje C# vendrá recargado.</div>
						<div class="blog_meta">
							<ul>
						...
						<div class="blog_image"><img src="images/course_26.jpg" alt=""></div>
						<p>:</p>
						...
						<p>C# (en inglés es pronunciado como “C Sharp”, en español como “C Almohadilla”), es un lenguaje de programación diseñado por la conocida compañía Microsoft. Fue estandarizado en hace un tiempo por la ECMA e ISO dos de las organizaciones más importantes a la hora de crear estándares para los servicios o productos. El lenguaje de programación C# está orientado a objetos.</p>
