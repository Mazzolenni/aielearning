...
<html lang="en">
<head>
<title>Python QUIZ |AIELearning</title>
<meta charset="utf-8">
				...
				<div class="container">
					<div class="row">
						<div class="col">
							...
							echo"<a href='quiz3alum.php?salir=1'>Cerrar Sesion</a>";
							}
							else {
...
<br><br><br><br><br><br><br><br>
  ...
  <title>Cuestionario Python</title>
  <div id="page-wrap">
  <h1>Cuestionario Nª1 Python</h1>
            ...
            <ol>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-1-answers-A">A) Entorno de desarrollo</label>
                    </div>

                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" />
                        <label for="question-1-answers-B">B) Conjunto de herramientas de edición</label>
                    </div>

                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" />
                        <label for="question-1-answers-C">C) Lenguaje de programación</label>
                    </div>

                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-D" value="D" />
                        <label for="question-1-answers-D">D) Compilador</label>
                    </div>
                ...
                <li>
                    ...
                    <h3>¿Qué opción genera este código? <br>
...
imprimir ((4 + 8) / 2)
                    ...
                    <div>
                        ...
                        <label for="question-2-answers-B">B) 6</label>
                    </div>

                    <div>
                        <input type="radio" name="question-2-answers" id="question-2-answers-C" value="C" />
                        <label for="question-2-answers-C">C) 6.0 </label>
                    </div>
                ...
                <li>
                    ...
                    <h3>¿Cuál de las siguientes opciones da como resultado exactamente dos líneas?</h3>

                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-A" value="A" />
                        <label for="question-3-answers-A">A)"Hola Mundo"</label>
                    </div>

                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-B" value="B" />
                        <label for="question-3-answers-B">B)"Aquí va un \ n texto \ n"</label>
                    </div>

                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-C" value="C" />
                        <label for="question-3-answers-C">C) 'uno dos tres'</label>
                    </div>

                    <div>
                        <input type="radio" name="question-3-answers" id="question-3-answers-D" value="D" />
                        <label for="question-3-answers-D">D) "Hola \ n mundo"</label>
                    </div>
                ...
                <li>
                    ...
                    <h3>¿Cuál de estos es un nombre de variable válido en Python?</h3>

                    <div>
                        <input type="radio" name="question-4-answers" id="question-4-answers-A" value="A" />
                        <label for="question-4-answers-A">A) A_VARIABLE_NAME</label>
                    </div>

                    <div>
                        <input type="radio" name="question-4-answers" id="question-4-answers-B" value="B" />
                        <label for="question-4-answers-B">B) un nombre de variable</label>
                    </div>

                    <div>
                        <input type="radio" name="question-4-answers" id="question-4-answers-C" value="C" />
                        <label for="question-4-answers-C">C) nombre-variable</label>
                    </div>
                ...
                <li>
                    ...
                    <h3>¿Cuál es el resultado de este código? <br>
...
imprimir (5 // 2)/<h3>
                    ...
                    <div>
                        ...
                        <label for="question-5-answers-D">D) 0.0</label>
                    </div>
