...
if(isset($_REQUEST['cursos']) && isset($_REQUEST['enviar'])) {
  $u=$_SESSION['user'];
	$tc=$_REQUEST['idtipocurso'];
	$n=$_REQUEST['cursos'];
	$t=$_REQUEST['tutor'];
	$i=$_FILES['imagennueva']['name'];
	$ic=$_FILES['iconos']['name'];
	...
	$consulta0 ="INSERT INTO cursos (nombre, tutor, descripcion, resumen, sintesis, imagen, iconos, idtipocurso) VALUES ('$n','$t','$d','$r','$s','$i','$ic','$tc')";
	$ejecutar0 = sqlsrv_query ($conn, $consulta0);
  move_uploaded_file ($_FILES['imagen']['tmp_name'], "imagencurso/".$i);
	  move_uploaded_file ($_FILES['iconos']['tmp_name'], "imagencurso/".$ic);
...
?>
		  ...
		  <br> <br><input type="text" class="form-control" id="name" name="cursos" <?php if(isset($_REQUEST['edi'])){ echo "value='".$a5['nombre']."'";} ?> placeholder="Nombre del curso">

		<br> <br>	<input type="text" class="form-control" id="name"  name="tutor" <?php if(isset($_REQUEST['edi'])){ echo "value='".$a5['tutor']."'";} ?>  placeholder="Nombre del tutor">
      <?php if(isset($_REQUEST['edi'])){
			echo "<input type='text' class='form-control' id='name'  name='imagenanterior' value='Foto Anterior: ".$a5['imagen']."' disabled >";
      }
			?>
			<br> <br><h3>Imagen.</h3>
			<br> <br><input type="file" class="form-control" id="name" name="imagennueva" required >
      <br> <br><h3>Icono.</h3>
			<br> <br><input type="file" class="form-control" id="name" name="iconos" required >
      <br> <br><h3>Descripcion.</h3>
			<br> <br> <textarea placeholder="Escriba tu descripcion aqui" name="descripcion" class="form-control" id="" cols="30" rows="10"> <?php if(isset($_REQUEST['edi'])){ echo $a5['descripcion'];} ?></textarea>
      <br> <br><br> <br><h3>Resumen.</h3>
      <br> <br> <textarea placeholder="Escriba tu resumen aqui" name="resumen" class="form-control" id="" cols="30" rows="10"> <?php if(isset($_REQUEST['edi'])){ echo $a5['resumen'];} ?></textarea>
    <br> <br> <h3> Sintesis.</h3>
			<br> <br> <textarea placeholder="Escriba tu sintesis aqui" name="sintesis" class="form-control" id="" cols="30" rows="10"> <?php if(isset($_REQUEST['edi'])){ echo $a5['sintesis'];} ?></textarea>
			<?php
			$consulta2 = "SELECT * FROM tipocurso ORDER BY idtipocurso ASC";
			$params2 = array();
	...
	echo	"<select name='idtipocurso'  id='courses_search_select' class='courses_search_select courses_search_input'>";
  if(isset($_REQUEST['edi'])){
	echo "<option>".$a6['nombre']."</option>";
  }
	else {
	...
	echo "<option value='".$a2['idtipocurso']."' >".$a2['nombre']."</option>";
}
...
echo "No hay tipos de cursos";
      ...
      ?>
			...
			<button class="btn academy-btn mt-30" name="enviar" type="submit">Enviar</button>
	</form>
</div>
