							...
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button">
										<?php
								if (isset($_SESSION['user'])) {
								echo"<a href='noticia1alum.php?salir=1'>Cerrar Sesion</a>";
								}
								else {
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">¡Kotlin llegará este verano a AIE-Learning!</div>
						<div class="blog_meta">
							<ul>
						...
						<div class="blog_image"><img src="images/course_25.jpg" alt=""></div>
						<p>:</p>
...
Así, Kotlin resuelve desafíos encontrados por los programadores. Por ejemplo, el sistema de tipado permite evitar excepciones ‘null pointer’. Los lenguajes de investigación académica tienden a no usar null en absoluto, pero eso no les sirve a los ingenieros de software que trabajan con mucho código y APIs.</p>
						<div class="blog_images">
							<div class="row">
								<div class="col-lg-6 blog_images_col"><div class="blog_image_small"><img src="images/course_29.jpg" width=400 height=200 alt=""></div></div>
								<div class="col-lg-6 blog_images_col"><div class="blog_image_small"><img src="images/course_30.jpg" width=400 height=200 alt=""></div></div>
							</div>
						</div>
