						...
						<div class="row courses_row">
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="quiz.php">C++</a></h3>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="quiz2.php">Php</a></h3>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="quiz3.php">Python</a></h3>
										<div class="course_teacher">Mr. isaias</div>
										<div class="course_text">
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="quiz5.php">Java</a></h3>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="quiz6.php">JavaScript</a></h3>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="quiz4.php">HTML</a></h3>
