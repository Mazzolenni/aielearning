							...
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button">
										<?php
								if (isset($_SESSION['user'])) {
								echo"<a href='noticia4alum.php?salir=1'>Cerrar Sesion</a>";
								}
								else {
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Nuevos Lenguajes</div>
						<div class="blog_meta">
							<ul>
								<li>Se posteó el <a href="">Mayo 5, 2021</a></li>
								<li>Por el <a href="">Admin</a></li>
							</ul>
						</div>
						<div class="blog_image"><img src="images/course_32.jpg" alt=""></div>
						<p>:</p>
						<div class="blog_quote d-flex flex-row align-items-center justify-content-start">
							<i class="fa fa-quote-left" aria-hidden="true"></i>
							<div>Nuevos Lenguajes a tus servicios.</div>
						</div>
						<p>Las aplicaciones web cambiaron para siempre nuestra realidad. Hoy, la tecnología atraviesa todos los trabajos y, saber programar, se convirtió en una habilidad clave. La carrera ofrece formación y acompañamiento para dar los primeros pasos en el que, hoy, es el rol más demandado por la industria a nivel mundial. Aprenderás desde los fundamentos de los lenguajes de programación, hasta el lanzamiento de aplicaciones web completas; a resolver problemas aplicando las mejores prácticas de la industria.</p>
						<div class="blog_subtitle">Los que estan incluidos seran:</div>
						<p>Switf: es un intuitivo lenguaje de programación creado por Apple que permite diseñar apps para iOS, Mac, el Apple TV y el Apple Watch. Está pensado para dar a los desarrolladores más libertad que nunca. Como es de código abierto y tan fácil de usar, con Swift cualquiera puede hacer realidad sus ideas.
<p>SQL: Como su nombre completo (Structured Query Language) implica, el lenguaje SQL es responsable de hacer consultas y editar la información almacenada en un determinado sistema de gestión de base de datos.
<p>Matlab: Matlab es la abreviatura de Matrix Laboratory, laboratorio de matrices, y es un sistema de cómputo numérico que ofrece un IDE (Entorno de Desarrollo Integrado) con lenguaje de programación propio.

Entre sus prestaciones se encuentran la representación de datos y funciones, creación de interfaz de usuario, la implementación de algoritmos o la comunicación con programas en otros lenguajes. </p>
						<div class="blog_images">
							<div class="row">
								<div class="col-lg-6 blog_images_col"><div class="blog_image_small"><img src="images/course_27.jpg" alt=""></div></div>
								<div class="col-lg-6 blog_images_col"><div class="blog_image_small"><img src="images/course_28.jpg" alt=""></div></div>
							</div>
						</div>
						<p>Esto no sera el limite AIE-Lernianos, esto es solo un comienzo en donde podremos avanzar e incluir cosas nuevas para que puedas desarrollarte e ir a nuevos horizontes.</p>
					</div>
