							...
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button">
										<?php
							if (isset($_SESSION['user'])) {
							echo"<a href='cursos2.php?salir=1'>Cerrar Sesion</a>";
							}
							else {
						...
						<div class="row courses_row">
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="ruby.php">Ruby</a></h3>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="css.php">Css</a></h3>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="javascript.php">JavaScript</a></h3>
