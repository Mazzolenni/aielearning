							...
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button">
										<?php
							if (isset($_SESSION['user'])) {
							echo"<a href='curso3.php?salir=1'>Cerrar Sesion</a>";
							}
							else {
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="courses_container">
						<div class="row courses_row">
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									<div class="course_image"><img src="images/course_25.jpg" width=400 height=200 alt=""></div>
									<div class="course_body">
										<h3 class="course_title"><a href="noticia1.php">Proximamente...</a></h3>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									<div class="course_image"><img src="images/course_26.jpg" width=400 height=200 alt=""></div>
									<div class="course_body">
										<h3 class="course_title"><a href="noticia5.php">Proximamente...</a></h3>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									<div class="course_image"><img src="images/course_27.jpg" width=400 height=200 alt=""></div>
									<div class="course_body">
										<h3 class="course_title"><a href="noticia4.php">Proximamente...</a></h3>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									<div class="course_image"><img src="images/course_28.jpg" width=400 height=200 alt=""></div>
									<div class="course_body">
										<h3 class="course_title"><a href="noticia4.php">Proximamente...</a></h3>
                    ...
                    <li><a href="cursos.php">1</a></li>
                    <li><a href="cursos2.php">2</a></li>
										<li class="active"><a href="cursos3.php">3</a></li>
...
<div class="contact-form-area wow fadeInUp" data-wow-delay="500ms">
	<form action="inicio.php" method="post" enctype="multipart/form-data">
			<input type="text" class="form-control" id="name" name="cursos" placeholder="Nombre del curso">
