							...
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button">
										<?php
								if (isset($_SESSION['user'])) {
								echo"<a href='blog.php?salir=1'>Cerrar Sesion</a>";
								}
								else {
					...
					echo "<a href='inicio.php'>
						...
						echo "<li><a href='inicio.php'>Hogar</a></li>";
								...
								echo "<li><a href='index.php'>Hogar</a></li>";
									...
									<li><a href="index.php?verificar=1">Cuestionarios</a></li>
								</ul>
				...
				<div class="col">
					<div class="blog_post_container">
						...
						<div class="blog_post trans_200">
							<div class="blog_post_image"><img src="images/course_25.jpg" alt=""></div>
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="noticia1.php">Kotlin Llegará este verano...</a></div>
						...
						<div class="blog_post trans_200">
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="noticia2.php">Nuevos Maestros.</a></div>
								<div class="blog_post_meta">
									<ul>
										<li><a href="">admin</a></li>
										<li><a href="">november 11, 2017</a></li>
						...
						<!-- Blog Post -->
						<div class="blog_post trans_200">
							<div class="blog_post_image"><img src="images/course_33.jpg" alt=""></div>
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="noticia3.php">!Juegos recreativos que te estimulen al aprendizaje!</a></div>
								<div class="blog_post_meta">
									<ul>
										<li><a href="">admin</a></li>
										<li><a href="">november 11, 2017</a></li>
						...
						<!-- Blog Post -->
						<div class="blog_post trans_200">
							<div class="blog_post_image"><img src="images/course_32.jpg" alt=""></div>
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="noticia4.php">Nuevos Lenguajes</a></div>
								<div class="blog_post_meta">
									<ul>
										<li><a href="">admin</a></li>
										<li><a href="">november 11, 2017</a></li>
						...
						<!-- Blog Post -->
						<div class="blog_post trans_200">
							<div class="blog_post_image"><img src="images/course_26.jpg" alt=""></div>
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="noticia5.php">El pack completo del Lenguaje C# vendrá recargado.</a></div>
								<div class="blog_post_meta">
									<ul>
										<li><a href="">admin</a></li>
										<li><a href="">november 11, 2017</a></li>
						...
						<!-- Blog Post -->
						<div class="blog_post trans_200">
							<div class="blog_post_image"><img src="images/course_31.jpg" width=300 height=185 alt=""></div>
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="noticia6.php">Por navidades traeremos sorpresas para nuestros AIE-Lernianos.</a></div>
								<div class="blog_post_meta">
									<ul>
										<li><a href="">admin</a></li>
										<li><a href="">november 11, 2017</a></li>
						...
						<div class="blog_post trans_200">
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="noticia7.php">Expansion de la pagina.</a></div>
								<div class="blog_post_meta">
									<ul>
										<li><a href="">admin</a></li>
										<li><a href="">november 11, 2017</a></li>
