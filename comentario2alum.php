...
if(isset($_REQUEST['nombre']) && !isset($_REQUEST['modificar'])) {
	...
	$consulta0 ="INSERT INTO comentario (usuario, nombre, email, comentario, fecha) VALUES ('$u','$n','$e','$c','$hoy')";
	$ejecutar0 = sqlsrv_query ($conn, $consulta0);
header ("location:comentario2.php");

}

if(isset($_REQUEST['eli'])){
	$consulta3 = "DELETE FROM comentario WHERE idcomentario =".$_REQUEST['eli'];
	$params3 = array();
	$options3 =  array( "Scrollable" => SQLSRV_CURSOR_KEYSET );
	$stmt3 = sqlsrv_query( $conn, $consulta3 , $params3, $options3 );
	header("Location: comentario2alum.php");
}
							...
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button">
										<?php
								if (isset($_SESSION['user'])) {
								echo"<a href='comentario2alum.php?salir=1'>Cerrar Sesion</a>";
								}
								else {
				...
				<div class="col-lg-8">
					...
					<div class="comments_container">
					 ...
					 <?php
						...
						<div class="comments_title"><span></span>Comentarios</div>
						<ul class="comments_list">
                         ...
                         <?php
												echo "<a href=''>" .$a2['nombre']. "</a></div>
											<div class='comment_rating'><div class='rating_r rating_r_4'><i></i><i></i><i></i><i></i><i></i></div></div>
											<div class='comment_time ml-auto'>".$a2['fecha']."</div>
										</div>
					...
					?>
						...
						<div class="add_comment_container">
							...
							<form action="comentario2.php" method="post" class="comment_form">
								<div>
